...
import AddNewBlog from './components/Deshboard/AddNewBlog/AddNewBlog.js';
import ManageBlogs from './components/Deshboard/ManageBlogs/ManageBlogs.js';
    ...
    <div className="App">
      <AuthProvider>
        <Routes>
          ...
          <Route path={`/dashboard/AddNewBlog`} element={<AdminRoute><AddNewBlog /></AdminRoute>} />
